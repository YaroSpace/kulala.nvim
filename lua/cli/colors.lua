...
M.get_hl_escape = function(hl_group, str)
  ...
  hl = vim.api.nvim_get_hl(0, { name = hl_group, link = false })["fg"]
...
M.print = function(str, hl_group)
  io.write(M.get_hl_escape(hl_group, str) .. "\n")
end
...
M.print_buf = function(buf, color)
  ...
  for l, line in ipairs(lines) do
    for c = 0, #line do
      ...
      syntax_hl = not treesitter_hl and char_i.syntax and char_i.syntax[1] and char_i.syntax[1].hl_group or "Normal"

      color_char = M.get_hl_escape(extmarks_hl or treesitter_hl or syntax_hl, char)
